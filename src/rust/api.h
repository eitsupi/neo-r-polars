...
SEXP savvy_PlRExpr_dt_timestamp__ffi(SEXP self__, SEXP c_arg__tu);
SEXP savvy_PlRExpr_dt_epoch_seconds__ffi(SEXP self__);
SEXP savvy_PlRExpr_dt_with_time_unit__ffi(SEXP self__, SEXP c_arg__tu);
SEXP savvy_PlRExpr_dt_cast_time_unit__ffi(SEXP self__, SEXP c_arg__tu);
