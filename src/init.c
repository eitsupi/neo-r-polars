...
SEXP savvy_PlRLazyFrame_new_from_ipc__impl(SEXP c_arg__path, SEXP c_arg__cache, SEXP c_arg__rechunk, SEXP c_arg__try_parse_hive_dates, SEXP c_arg__retries, SEXP c_arg__n_rows, SEXP c_arg__row_index_name, SEXP c_arg__row_index_offset, SEXP c_arg__cloud_options, SEXP c_arg__hive_partitioning, SEXP c_arg__hive_schema, SEXP c_arg__file_cache_ttl, SEXP c_arg__include_file_paths) {
    SEXP res = savvy_PlRLazyFrame_new_from_ipc__ffi(c_arg__path, c_arg__cache, c_arg__rechunk, c_arg__try_parse_hive_dates, c_arg__retries, c_arg__n_rows, c_arg__row_index_name, c_arg__row_index_offset, c_arg__cloud_options, c_arg__hive_partitioning, c_arg__hive_schema, c_arg__file_cache_ttl, c_arg__include_file_paths);
    return handle_result(res);
}
