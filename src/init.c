...
SEXP savvy_PlRExpr_map_batches__impl(SEXP self__, SEXP c_arg__lambda, SEXP c_arg__agg_list, SEXP c_arg__is_elementwise, SEXP c_arg__returns_scalar, SEXP c_arg__return_dtype) {
    SEXP res = savvy_PlRExpr_map_batches__ffi(self__, c_arg__lambda, c_arg__agg_list, c_arg__is_elementwise, c_arg__returns_scalar, c_arg__return_dtype);
    return handle_result(res);
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"savvy_PlRExpr_map_batches__impl", (DL_FUNC) &savvy_PlRExpr_map_batches__impl, 6},
