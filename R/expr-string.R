...
#'
#' @param pattern A character or something can be coerced to a string [Expr][expression]
...
#' @param value A character or an [Expr][expression] of string
...
#' @param patterns Character vector or something can be coerced to strings [Expr][expression]
#' of a valid regex pattern, compatible with the [regex crate](https://docs.rs/regex/latest/regex/).
