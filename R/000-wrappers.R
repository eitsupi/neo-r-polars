...
`PlRLazyFrame_sink_ipc` <- function(self) {
  function(`path`, `compression`, `compat_level`, `maintain_order`, `retries`, `storage_options` = NULL) {
    invisible(.Call(savvy_PlRLazyFrame_sink_ipc__impl, `self`, `path`, `compression`, `compat_level`, `maintain_order`, `retries`, `storage_options`))
  }
}
