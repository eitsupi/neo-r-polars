...
`PlRLazyFrame`$`new_from_csv` <- function(`path`, `separator`, `has_header`, `ignore_errors`, `skip_rows`, `cache`, `missing_utf8_is_empty_string`, `low_memory`, `rechunk`, `skip_rows_after_header`, `encoding`, `try_parse_dates`, `eol_char`, `raise_if_empty`, `truncate_ragged_lines`, `decimal_comma`, `glob`, `retries`, `comment_prefix` = NULL, `quote_char` = NULL, `null_values` = NULL, `infer_schema_length` = NULL, `row_index_name` = NULL, `row_index_offset` = NULL, `n_rows` = NULL, `overwrite_dtype` = NULL, `schema` = NULL, `cloud_options` = NULL, `file_cache_ttl` = NULL, `include_file_paths` = NULL) {
  .savvy_wrap_PlRLazyFrame(.Call(savvy_PlRLazyFrame_new_from_csv__impl, `path`, `separator`, `has_header`, `ignore_errors`, `skip_rows`, `cache`, `missing_utf8_is_empty_string`, `low_memory`, `rechunk`, `skip_rows_after_header`, `encoding`, `try_parse_dates`, `eol_char`, `raise_if_empty`, `truncate_ragged_lines`, `decimal_comma`, `glob`, `retries`, `comment_prefix`, `quote_char`, `null_values`, `infer_schema_length`, `row_index_name`, `row_index_offset`, `n_rows`, `overwrite_dtype`, `schema`, `cloud_options`, `file_cache_ttl`, `include_file_paths`))
}
