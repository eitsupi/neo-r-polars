...
`PlRLazyFrame_sink_json` <- function(self) {
  function(`path`, `retries`, `maintain_order`, `_storage_options` = NULL) {
    invisible(.Call(savvy_PlRLazyFrame_sink_json__impl, `self`, `path`, `retries`, `maintain_order`, `_storage_options`))
  }
}
