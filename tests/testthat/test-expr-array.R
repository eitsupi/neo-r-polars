...
test_that("arr$reverse", {
  ...
  expect_equal(
    ...
    pl$DataFrame(a = list(c(2, 2, Inf), c(2, NaN, 4)))
  )
})
...
test_that("arr$unique", {
  ...
  expect_equal(
    ...
    pl$DataFrame(a = list(c(2, Inf), c(2, 4, NaN)))
  )
})
...
test_that("arr$sort", {
  ...
  expect_equal(
    ...
    pl$DataFrame(a = list(c(2, 2, Inf), c(2, 4, NaN)))
  )
})
...
test_that("arr$get", {
  ...
  expect_equal(
    ...
    pl$DataFrame(a = c(2, NaN))
  )
  # with expr
  expect_equal(
    df$select(pl$col("a")$arr$get("b")),
    pl$DataFrame(a = c(2, 2))
  )
})
...
test_that("arr$arg_max and arr$arg_min", {
  ...
  expect_equal(
    ...
    pl$DataFrame(a = c(1, 0, NA_integer_))
  )

  # arg_min ---
  expect_equal(
    df$select(pl$col("a")$arr$arg_min()),
    pl$DataFrame(a = c(0, 0, NA_real_))
  )
})
...
test_that("arr$var", {
  ...
  expect_equal(
    ...
    pl$DataFrame(floats = c(1, 6.3333, NA)),
    tolerance = 0.0001
  )
  expect_equal(
...
test_that("arr$std", {
  ...
  expect_equal(
    ...
    pl$DataFrame(floats = c(1, 2.5166, NA)),
    tolerance = 0.0001
  )
  expect_equal(
    df$select(pl$col("strings")$arr$median()),
...
test_that("arr$shift", {
  ...
  expect_equal(
    ...
    pl$DataFrame(strings = list(c(NA, "a"), c(NA, "c")))
  )
  expect_equal(
    df$select(pl$col("strings")$arr$shift(-1)),
    pl$DataFrame(strings = list(c("b", NA), c("d", NA)))
  )
})
